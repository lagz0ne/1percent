...
1. Check if `.autoresearch/current` exists in the working directory and points to a session under `.autoresearch/sessions/<session-id>/`

If true, this is an active autoresearch session. **Do not stop.** Instead:
